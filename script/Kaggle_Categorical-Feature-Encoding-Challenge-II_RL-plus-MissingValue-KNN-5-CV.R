...
set.seed(215)
i_treino <- createDataPartition(dt$target, p = 0.8, list = FALSE)
...
saveRDS(mc_cv, file = 'matrizConfusao-KNN-5-CV.RDS')
...
fwrite(previsao_final, file = './prevFinal-KNN-5-CV.csv')
