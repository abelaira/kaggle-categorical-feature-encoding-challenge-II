...
arquivo <- 'dt-Treino_MissingValue_PMM-v2.csv'
if (file.exists(paste('./',arquivo, sep = ''))) {
  ...
  dados_treino_1[,':='(bin_0 = factor(dados_treino_1$bin_0),
                       ...
                       nom_5 = dados_treino_1$nom_5,
                       nom_6 = dados_treino_1$nom_6,
                       nom_7 = factor(dados_treino_1$nom_7),
                       nom_8 = factor(dados_treino_1$nom_8),
                       nom_9 = dados_treino_1$nom_9,
...
saveRDS(mc, file = 'matrizConfusao-PMM-v2.RDS')
...
arquivo <- 'dt-Teste_MissingValue_PMM-v2.csv'
if (file.exists(paste('./',arquivo, sep = ''))) {
  ...
  dados_teste_1[,':='(bin_0 = factor(dados_teste_1$bin_0),
                      ...
                      nom_5 = dados_teste_1$nom_5,
                      nom_6 = dados_teste_1$nom_6,
                      nom_7 = factor(dados_teste_1$nom_7),
                      nom_8 = factor(dados_teste_1$nom_8),
                      nom_9 = dados_teste_1$nom_9,
...
fwrite(previsao_final, file = './prevFinal-PMM-v2.csv')
