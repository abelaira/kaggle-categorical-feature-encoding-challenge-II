...
dados_treino_1[,':='(bin_0 = as.factor(dados_treino_1$bin_0),
                     ...
                     nom_5 = as.factor(dados_treino_1$nom_5),
...
saveRDS(mc, file = 'matrizConfusao-LOCF.RDS')
...
dados_teste_1[,':='(bin_0 = as.factor(dados_teste_1$bin_0),
                    ...
                    nom_5 = as.factor(dados_teste_1$nom_5),
...
fwrite(previsao_final, file = './prevFinal-LOCF.csv')
