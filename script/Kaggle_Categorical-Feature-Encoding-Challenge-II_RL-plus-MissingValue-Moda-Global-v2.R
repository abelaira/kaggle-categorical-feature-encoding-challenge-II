...
dados_tratados[,':='(bin_0 = factor(dados_originais$bin_0),
                     ...
                     nom_5 = as.integer(factor(dados_originais$nom_5)),
...
dados_treino_1[which(vet_na[,11]),11] <- as.integer(moda(dados_treino_1$nom_5))
dados_treino_1[which(vet_na[,12]),12] <- as.integer(moda(dados_treino_1$nom_6))

dados_treino_1[which(vet_na[,13]),13] <- moda(dados_treino_1$nom_7)
dados_treino_1[which(vet_na[,14]),14] <- moda(dados_treino_1$nom_8)

dados_treino_1[which(vet_na[,15]),15] <- as.integer(moda(dados_treino_1$nom_9))

dados_treino_1[which(vet_na[,16]),16] <- as.integer(moda(dados_treino_1$ord_0))
dados_treino_1[which(vet_na[,17]),17] <- as.integer(moda(dados_treino_1$ord_1))
dados_treino_1[which(vet_na[,18]),18] <- as.integer(moda(dados_treino_1$ord_2))
dados_treino_1[which(vet_na[,19]),19] <- as.integer(moda(dados_treino_1$ord_3))
dados_treino_1[which(vet_na[,20]),20] <- as.integer(moda(dados_treino_1$ord_4))
dados_treino_1[which(vet_na[,21]),21] <- as.integer(moda(dados_treino_1$ord_5))

dados_treino_1[which(vet_na[,22]),22] <- as.integer(moda(dados_treino_1$day))
dados_treino_1[which(vet_na[,23]),23] <- as.integer(moda(dados_treino_1$month))
...
(mc_v2 <- confusionMatrix(data = previsao, reference = dt_teste$target))
saveRDS(mc_v2, file = "matrizConfusao-ModaGlobal-v2.RDS")
...
dados_tratados_teste[,':='(bin_0 = factor(dados_testes$bin_0),
                     ...
                     nom_5 = as.integer(factor(dados_testes$nom_5)),
...
dados_teste_1[which(vet_na[,11]),11] <- as.integer(moda(dados_teste_1$nom_5))
dados_teste_1[which(vet_na[,12]),12] <- as.integer(moda(dados_teste_1$nom_6))

dados_teste_1[which(vet_na[,13]),13] <- moda(dados_teste_1$nom_7)
dados_teste_1[which(vet_na[,14]),14] <- moda(dados_teste_1$nom_8)

dados_teste_1[which(vet_na[,15]),15] <- as.integer(moda(dados_teste_1$nom_9))

dados_teste_1[which(vet_na[,16]),16] <- as.integer(moda(dados_teste_1$ord_0))
dados_teste_1[which(vet_na[,17]),17] <- as.integer(moda(dados_teste_1$ord_1))
dados_teste_1[which(vet_na[,18]),18] <- as.integer(moda(dados_teste_1$ord_2))
dados_teste_1[which(vet_na[,19]),19] <- as.integer(moda(dados_teste_1$ord_3))
dados_teste_1[which(vet_na[,20]),20] <- as.integer(moda(dados_teste_1$ord_4))
dados_teste_1[which(vet_na[,21]),21] <- as.integer(moda(dados_teste_1$ord_5))

dados_teste_1[which(vet_na[,22]),22] <- as.integer(moda(dados_teste_1$day))
dados_teste_1[which(vet_na[,23]),23] <- as.integer(moda(dados_teste_1$month))

head(dados_teste_1, n = 10)
anyNA(dados_teste_1)

pred_rl_prob <- predict(fit_rl, newdata = dados_teste_1, type = 'response')
...
fwrite(previsao_final, file = './prevFinal-ModaGlobal-v2.csv')
